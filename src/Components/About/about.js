    ...
    render() {
        return (
                ...
                <div className="nine columns main-col">
                    <h2>About Me</h2>
                    <p>I'm currently the Section Lead for, and one of the Project Managers of, Lambda School's "Lambda Next", a post-graduate program designed to help its alumni land Software Engineering jobs quickly. I'm super excited, grateful, and privileged to be part of this awesome project.</p>
